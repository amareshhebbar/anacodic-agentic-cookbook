...
pip install -r 01-modules/01-extract/requirements.txt
jupyter notebook 01-modules/01-extract/01-pdf-printed.ipynb
```
...
jupyter nbconvert --execute --to notebook --inplace \
  01-modules/01-extract/01-pdf-printed.ipynb
```
